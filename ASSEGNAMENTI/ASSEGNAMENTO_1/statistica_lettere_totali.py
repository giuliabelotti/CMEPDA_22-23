...
def conteggio_lettere(file_path):
    ...
    lettere="abcdefghijklmnopqrstyvwxyz"
    freq={}
    lettere_m="ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    freq_m={}
    for i in lettere:
        freq[i]=0
    for j in lettere_m:
...
def histogram():
    ...
    """
    plt.figure('Lettere minuscole')
    plt.bar(index,f)
    plt.figure('Lettere maiuscole')
    plt.bar(indexM,g)
